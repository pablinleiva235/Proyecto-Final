...
En esta sección se configuran las señales digitales y analogicas del AURA 1000

## <span style="color: #111184;">**digital_signals.py** </span>

### <span style="color: #2196F3;">Diccionario de Señales Digitales </span>

En este diccionario se configura puerto, bit, dirección, estado activo y estado inicial de cada señal digital

??? note "Ver Diccionario de Señales Completo (DIGITALSIGNALS)"
    ```python
    DIGITALSIGNALS = {
...
### <span style="color: #2196F3;">Constantes utilizadas</span>
